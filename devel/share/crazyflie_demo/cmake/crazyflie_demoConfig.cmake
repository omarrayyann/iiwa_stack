...
if("TRUE" STREQUAL "TRUE")
  set(crazyflie_demo_SOURCE_PREFIX /home/cair1/github_packages/iiwa_stack/src/my_crazyflie_ros/crazyflie_demo)
  set(crazyflie_demo_DEVEL_PREFIX /home/cair1/github_packages/iiwa_stack/devel)
  ...
  set(crazyflie_demo_INSTALL_PREFIX /home/cair1/github_packages/iiwa_stack/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'crazyflie_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cair1/github_packages/iiwa_stack/src/my_crazyflie_ros/crazyflie_demo/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(crazyflie_demo_EXPORTED_TARGETS ${${crazyflie_demo_dep}_EXPORTED_TARGETS})
endforeach()

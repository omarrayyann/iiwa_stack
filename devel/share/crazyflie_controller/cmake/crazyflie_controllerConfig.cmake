...
if("TRUE" STREQUAL "TRUE")
  set(crazyflie_controller_SOURCE_PREFIX /home/cair1/github_packages/iiwa_stack/src/my_crazyflie_ros/crazyflie_controller)
  set(crazyflie_controller_DEVEL_PREFIX /home/cair1/github_packages/iiwa_stack/devel)
  ...
  set(crazyflie_controller_INSTALL_PREFIX /home/cair1/github_packages/iiwa_stack/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'crazyflie_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cair1/github_packages/iiwa_stack/src/my_crazyflie_ros/crazyflie_controller/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(crazyflie_controller_EXPORTED_TARGETS ${${crazyflie_controller_dep}_EXPORTED_TARGETS})
endforeach()

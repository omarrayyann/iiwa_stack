...
(cl:defmethod cl:initialize-instance :after ((m <OmniFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OmniFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name omni_driver-msg:<OmniFeedback> is deprecated: use omni_driver-msg:OmniFeedback instead.")))

(cl:ensure-generic-function 'force-val :lambda-list '(m))
(cl:defmethod force-val ((m <OmniFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omni_driver-msg:force-val is deprecated.  Use omni_driver-msg:force instead.")
  (force m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <OmniFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omni_driver-msg:position-val is deprecated.  Use omni_driver-msg:position instead.")
  (position m))

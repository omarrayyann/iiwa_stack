...
(cl:defmethod cl:initialize-instance :after ((m <OmniState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OmniState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name omni_driver-msg:<OmniState> is deprecated: use omni_driver-msg:OmniState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <OmniState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omni_driver-msg:header-val is deprecated.  Use omni_driver-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'locked-val :lambda-list '(m))
(cl:defmethod locked-val ((m <OmniState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omni_driver-msg:locked-val is deprecated.  Use omni_driver-msg:locked instead.")
  (locked m))

(cl:ensure-generic-function 'close_gripper-val :lambda-list '(m))
(cl:defmethod close_gripper-val ((m <OmniState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omni_driver-msg:close_gripper-val is deprecated.  Use omni_driver-msg:close_gripper instead.")
  (close_gripper m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <OmniState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omni_driver-msg:pose-val is deprecated.  Use omni_driver-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <OmniState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omni_driver-msg:current-val is deprecated.  Use omni_driver-msg:current instead.")
  (current m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <OmniState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omni_driver-msg:velocity-val is deprecated.  Use omni_driver-msg:velocity instead.")
  (velocity m))

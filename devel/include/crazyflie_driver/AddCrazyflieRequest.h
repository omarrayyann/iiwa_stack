...
struct AddCrazyflieRequest_
{
  ...
  _enable_parameters_type enable_parameters;
   ...
   typedef std::vector< ::crazyflie_driver::LogBlock_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::crazyflie_driver::LogBlock_<ContainerAllocator> >> _log_blocks_type;
...
bool operator==(const ::crazyflie_driver::AddCrazyflieRequest_<ContainerAllocator1> & lhs, const ::crazyflie_driver::AddCrazyflieRequest_<ContainerAllocator2> & rhs)
{
  return lhs.uri == rhs.uri &&
    ...
    lhs.enable_parameters == rhs.enable_parameters &&
    lhs.log_blocks == rhs.log_blocks &&
    lhs.use_ros_time == rhs.use_ros_time &&
    lhs.enable_logging_imu == rhs.enable_logging_imu &&
    lhs.enable_logging_temperature == rhs.enable_logging_temperature &&
    lhs.enable_logging_magnetic_field == rhs.enable_logging_magnetic_field &&
    lhs.enable_logging_pressure == rhs.enable_logging_pressure &&
    lhs.enable_logging_battery == rhs.enable_logging_battery &&
    lhs.enable_logging_pose == rhs.enable_logging_pose &&
    lhs.enable_logging_packets == rhs.enable_logging_packets;
}

...
bool operator==(const ::crazyflie_driver::RemoveCrazyflieRequest_<ContainerAllocator1> & lhs, const ::crazyflie_driver::RemoveCrazyflieRequest_<ContainerAllocator2> & rhs)
{

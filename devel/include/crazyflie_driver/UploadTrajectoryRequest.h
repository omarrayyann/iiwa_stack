...
struct UploadTrajectoryRequest_
{
  ...
  _pieceOffset_type pieceOffset;
   ...
   typedef std::vector< ::crazyflie_driver::TrajectoryPolynomialPiece_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::crazyflie_driver::TrajectoryPolynomialPiece_<ContainerAllocator> >> _pieces_type;
  _pieces_type pieces;
...
bool operator==(const ::crazyflie_driver::UploadTrajectoryRequest_<ContainerAllocator1> & lhs, const ::crazyflie_driver::UploadTrajectoryRequest_<ContainerAllocator2> & rhs)
{

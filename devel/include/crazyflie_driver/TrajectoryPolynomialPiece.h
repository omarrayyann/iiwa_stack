...
bool operator==(const ::crazyflie_driver::TrajectoryPolynomialPiece_<ContainerAllocator1> & lhs, const ::crazyflie_driver::TrajectoryPolynomialPiece_<ContainerAllocator2> & rhs)
{

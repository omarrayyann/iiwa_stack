...
bool operator==(const ::crazyflie_driver::StartTrajectoryRequest_<ContainerAllocator1> & lhs, const ::crazyflie_driver::StartTrajectoryRequest_<ContainerAllocator2> & rhs)
{

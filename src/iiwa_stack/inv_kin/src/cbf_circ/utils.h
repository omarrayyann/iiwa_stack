...
public:
    ...
    static Matrix3d rotaxis(double theta, Vector3d axis);
    ...
    static VectorXd randVec(int n, double vMin = 0, double vMax = 1);
    ...
    static string printVector(VectorXd v, int nochar=8);

    static string printVectorOctave(VectorXd v, int nochar=8);

    static string printMatrix(MatrixXd M, int nochar=8);

    static string printMatrixPython(MatrixXd M, int nochar=8);

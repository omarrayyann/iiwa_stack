...
DistanceStruct GeometricPrimitives::computeDist(GeometricPrimitives* objA, GeometricPrimitives* objB, Vector3d pointA0,
                                                double tol)
{
...
{
  Vector3d p1 = this->width * this->htm.block<3, 1>(0, 0) + this->depth * this->htm.block<3, 1>(0, 1) +
                this->height * this->htm.block<3, 1>(0, 2);
  Vector3d p2 = -this->width * this->htm.block<3, 1>(0, 0) + this->depth * this->htm.block<3, 1>(0, 1) +
                this->height * this->htm.block<3, 1>(0, 2);
  Vector3d p3 = this->width * this->htm.block<3, 1>(0, 0) - this->depth * this->htm.block<3, 1>(0, 1) +
                this->height * this->htm.block<3, 1>(0, 2);
  Vector3d p4 = this->width * this->htm.block<3, 1>(0, 0) + this->depth * this->htm.block<3, 1>(0, 1) -
                this->height * this->htm.block<3, 1>(0, 2);
...
AxisAlignedBoundingBox Cylinder::getAABB()
{
  ...
  Vector3d p1 = dradius * this->htm.block<3, 1>(0, 0) + dradius * this->htm.block<3, 1>(0, 1) +
                this->height * this->htm.block<3, 1>(0, 2);
  Vector3d p2 = -dradius * this->htm.block<3, 1>(0, 0) + dradius * this->htm.block<3, 1>(0, 1) +
                this->height * this->htm.block<3, 1>(0, 2);
  Vector3d p3 = dradius * this->htm.block<3, 1>(0, 0) - dradius * this->htm.block<3, 1>(0, 1) +
                this->height * this->htm.block<3, 1>(0, 2);
  Vector3d p4 = dradius * this->htm.block<3, 1>(0, 0) + dradius * this->htm.block<3, 1>(0, 1) -
                this->height * this->htm.block<3, 1>(0, 2);

...
int main(int argc, char* argv[])
{
  ...
  ros::Subscriber KUKASubscriber1 = n.subscribe("/iiwa/state/JointPosition", 5, kukaCallJoints);
  ros::Subscriber touchSubscriber1 = n.subscribe("/phantom/joint_states", 5, touchCallJoints);
  ros::Subscriber touchSubscriber2 = n.subscribe("/phantom/pose", 5, touchCallEEFPosition);
  KUKAJointsPublisher = n.advertise<iiwa_msgs::JointPosition>("/iiwa/command/JointPosition", 5);
  ...
  Matrix4d htmStart = Utils::trn(0.45, 0, 0.55 - 0.40) * Utils::roty(3.14);

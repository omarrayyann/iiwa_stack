...
public:
  ...
  static Manipulator createKukaIIWAUAIBot();
  ...
  ConstControlResult constControl(Matrix4d taskHtm, vector<GeometricPrimitives*> obstacles = {},
                                  ConstControlResult* oldControlStruct = NULL,
                                  ConstControlParam param = ConstControlParam(), VectorXd q = VectorXd(0),
                                  Matrix4d customHtmWorldToBase = Matrix4d::Zero());
